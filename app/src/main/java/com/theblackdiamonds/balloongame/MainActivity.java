package com.theblackdiamonds.balloongame;
...
public class MainActivity extends AppCompatActivity {
    ...
    private int balloonsLeft = 20, sound;
    private Point point;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CustomArFragment arFragment = (CustomArFragment) getSupportFragmentManager()
    ...
    private void buildBulletModel() {
        ...
        Texture.builder().setSource(this, R.drawable.texture).build()
                .thenAccept(texture -> MaterialFactory.makeOpaqueWithTexture(this, texture)
                        .thenAccept(material -> bulletRenderable = ShapeFactory
